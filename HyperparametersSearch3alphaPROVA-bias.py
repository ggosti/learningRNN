...
#print(x.shape)
# Aggiungi una colonna di 1 per il bias
...
# %%
t_mats = np.zeros((g, n_alpha, n_xi,N+1,N+1))      #n°segmenti x n° alpha x n°xi x n°neuroni x n°neuroni x 
