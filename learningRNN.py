...
import sys, os
sys.path.append("/Users/edo/anaconda2/lib/python2.7/site-packages")
import pandas as pd
import networkx as nx


#sys.path.insert(0, os.path.expanduser("/home/gosti/SSD2/gcrTools/venv/lib/python2.7/site-packages"))
import numpy as np

print 'numpy ver', np.__version__

dataFolder = '/Desktop/cervelloIIT/gcrTools-ed/'
